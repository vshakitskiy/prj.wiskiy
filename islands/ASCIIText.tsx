...
const PX_RATIO = typeof globalThis.window !== "undefined"
...
class AsciiFilter {
  ...
  reset() {
    ...
    this.pre.style.left = "10px"
    this.pre.style.top = "0"
    this.pre.style.zIndex = "9"
    // this.pre.style.letterSpacing = "1px"
...
class CanvAscii {
  ...
  textCanvas: CanvasTxt | null = null
  ...
  constructor(
    ...
    // @ts-ignore property position does exist
  ...
  setSize(w: number, h: number) {
    ...
    // @ts-ignore ?unkown property "aspect"
    this.camera.aspect = w / h
    // @ts-ignore ?unkown method "updateProjectionMatrix"
  ...
  onMouseMove(evt: MouseEvent | TouchEvent) {
    const e = evt instanceof MouseEvent ? evt : evt.touches[0]
  ...
  render() {
    ...
    // @ts-ignore property uniforms does exist
  ...
  updateRotation() {
    ...
    // @ts-ignore property rotation does exist
